...
class ComplianceRequest(BaseModel):
    ...
    compliance_standard: str = Field(..., description="合规标准（如 GDPR、数据安全法）")
    industry: Optional[str] = Field("未指定", description="行业领域")
    jurisdiction: Optional[str] = Field("中国大陆", description="司法管辖区")
